...
//		
	...
	public static void singleSend(String userid, String pwd,boolean isEncryptPwd)
	{
		try
		{
			...
			// 设置手机号码 此处只能设置一个手机号码
			message.setMobile("18789271536");
			// 设置内容
			message.setContent("您的验证码是123456，在3分钟内输入有效。如非本人操作请忽略此短信。");
			// 设置扩展号
			message.setExno("11");
			// 用户自定义流水编号
			message.setCustid("20160929194950100003");
			// 自定义扩展数据
